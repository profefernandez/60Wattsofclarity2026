      ...
      <div className="site-footer__inner max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <section className="site-footer__contact" aria-label="Contact call to action">
          ...
          <ul className="site-footer__actions flex flex-col gap-2 text-[#d9d9d9] text-sm">
            <li>
              <NavLink to="/learn-ai" className="site-footer__cta inline-block px-4 py-2 rounded-full bg-[#ffb300] text-black font-bold text-sm hover:brightness-105 transition-colors mt-2">
                Book a Session
              </NavLink>
            </li>
            <li className="mt-3">
              <NavLink to="/contact" className="site-footer__link text-[#d9d9d9]">
                Send us a message →
              </NavLink>
            </li>
          </ul>
